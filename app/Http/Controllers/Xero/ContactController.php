...
class ContactController extends Controller
{
    ...
    public function getContactsWithNumber(Request $request)
    {
        try {
            // Sesuaikan dengan method/token Anda
            ...
            if (!$tenantId) {
                return response()->json([
                    'success' => false,
                    'message' => 'XERO_TENANT_ID belum dikonfigurasi.',
                ], 500);
            }
            ...
            do {
                ...
                if (!$responseCheck->successful()) {
                    ...
                    Log::error('Xero Get Contacts Error', [
                        'page' => $page,
                        'status' => $responseCheck->status(),
                        'body' => $responseCheck->body(),
                    ]);
                    ...
                    return response()->json([
                        'success' => false,
                        'message' => 'Gagal mengambil Contact dari Xero.',
                        'page' => $page,
                        'status' => $responseCheck->status(),
                        'error' => $responseCheck->json(),
                ...
                /*
                 * Jika kurang dari 100 berarti halaman terakhir.
                 *
                 * Xero biasanya mengembalikan maksimal 100 data/page.
                 */
                $countPage = count($contacts);

                $page++;

                /*
                 * Pengaman supaya tidak infinite loop
                 */
                if ($countPage < 100) {
                    break;
                }
            ...
            Log::error('Exception Get Xero Contacts', [
            ...
            return response()->json([
                'success' => false,
                'message' => 'Terjadi kesalahan saat mengambil Contact Xero.',
                'error' => $e->getMessage(),
            ], 500);
        }
    }
