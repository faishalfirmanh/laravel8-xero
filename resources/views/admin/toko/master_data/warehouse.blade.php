...
<div class="card shadow mb-5">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0">List Of Warehouse</h5>
        ...
        <div class="modal-content">
            ...
            <form id="formCreateHotel">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group"> <label for="nameHotel">Nama Gudang</label>
                        <input type="text" class="form-control" id="code" disabled name="code" placeholder="auto by system">
                    </div>
                    <div class="form-group"> <label for="name">Nama Gudang</label>
                        <input type="text" class="form-control" id="name" name="name" placeholder="" required>
                    </div>

                    <div class="form-group"> <label for="address">Alamat</label>
                        <input type="text" class="form-control" id="address" name="address" placeholder="Jl. Soekarno hatta no 14" required>
                    </div>
