...
<div class="card shadow mb-5">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0">Daftar Lini Usaha</h5>
        ...
        <div class="modal-content">
            <form id="formRoleUser">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Form Lini Bisnis</h5>
...
$(document).ready(function () {
    ...
    table = initGlobalDataTableToken(
        ...
        [
            ...
            { data: 'name_business', name: 'name_business' },
            {
                data: 'is_active',
                name: 'is_active',
    ...
    $('#tableRoleUser').on('click', '.edit', function () {
        ...
        $('#nama_role').val(data.name_business);
